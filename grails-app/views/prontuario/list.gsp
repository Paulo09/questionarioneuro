...
<html>
    ...
    <body style="background-image:url(${createLinkTo(dir:'images/view/list/backgroundPagina',file:'backgroundPagina.jpg')});background-repeat:no-repeat;background-size:cover;">
        <div class="card">
		  ...
		  <span class="card-title"><b>L</b>ista <b>Prontuario</b></span>
		</div>
        <div class="body">
            ...
            <div class="list">
                <table class="striped centered grey lighten-2">
                    ...
                    <tbody>
                    <g:each in="${prontuarioList}" status="i" var="prontuario">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        
                            <td><g:link action="show" id="${prontuario.id}">${fieldValue(bean:prontuario, field:'id')}</g:link></td>
			...
			<nav class="nav-extended btn waves-effect waves-light" style="background-image:url(${createLinkTo(dir:'images/view/list/backgroundPagina',file:'backgroundPagina.jpg')});">  
				 <ul class="pagination" align="center"><li class="active" style="background-image:url(${createLinkTo(dir:'images/view/list/paginacao',file:'paginacao.jpg')});"><g:paginate total="${Prontuario.count()}"/></ul>
            </nav>
        </div>
