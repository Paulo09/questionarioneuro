...
<html>
	...
	<nav class="nav-extended btn waves-effectred red lighten-2">  
		<div class="nav-content">
		  <ul class="tabs tabs-transparent">
			<li class="tab"><a href="/teste/usuario/menu" target="_self">Voltar</a></li>
			<li class="tab"><a class="active">Listar</a></li>
			<li class="tab"><a href="/teste/questionarioenfermagem/create" target="_self">Novo</a></li>
		  </ul>
		</div>
	</nav>
