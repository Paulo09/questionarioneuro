                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'chanceCochilar','errors')}">
                                    <i class="fa fa-list"></i><g:select id="chanceCochilar" name="chanceCochilar" from="${questionariopresono.constraints.chanceCochilar.inList}" value="${questionariopresono.chanceCochilar}" ></g:select>
                                </td>
                            </tr>
