...
<html>
    ...
    <body style="background-image:url(${createLinkTo(dir:'images/view/create/backgroundPagina',file:'backgroundPagina.jpg')});background-repeat:no-repeat;background-size:cover;">
        <div class="card">
		  ...
		  <span class="card-title"><b>C</b>adastrar <b>Questionariopresono</b></span>
		</div>
        <div class="body">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'tratamentoApineiaSono','errors')}">
									...
									<label for="tratamentoApineiaSono"><font size="3"><b>Tratamento Apineia Sono</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'voceTem','errors')}">
									...
									<label for="voceTem"><font size="3"><b>Voce Tem</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'quantoTempodemoraDormir','errors')}">
									...
									<label for="quantoTempodemoraDormir"><font size="3"><b>Quanto Tempodemora Dormir</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'comoVocecordaCostume','errors')}">
									...
									<label for="comoVocecordaCostume"><font size="3"><b>Como Vocecorda Costume</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'sentemuitaSonolencia','errors')}">
									...
									<label for="sentemuitaSonolencia"><font size="3"><b>Sentemuita Sonolencia</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'sentemuitaFadiga','errors')}">
									...
									<label for="sentemuitaFadiga"><font size="3"><b>Sentemuita Fadiga</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'bebidaAlcoolica','errors')}">
									...
									<label for="bebidaAlcoolica"><font size="3"><b>Bebida Alcoolica</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'sintomasSonoFamilia','errors')}">
									...
									<label for="sintomasSonoFamilia"><font size="3"><b>Sintomas Sono Familia</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'chanceCochilar','errors')}">
                                    <i class="fa fa-text-width"></i><g:select type="text" class="form-control" size="50" placeholder="Digite chanceCochilar " id="chanceCochilar" name="chanceCochilar" size="50" value="${fieldValue(bean:questionariopresono,field:'chanceCochilar')}"></g:select>
									<label for="chanceCochilar"><font size="3"><b>Chance Cochilar</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'fuma','errors')}">
                                   <g:checkBox onclick="Mudarestado('qualTipo')" class="form-control" size="50" placeholder="Digite fuma " id="fuma" name="fuma" size="50" value="${fieldValue(bean:questionariopresono,field:'fuma')}"></g:checkBox>
                                 ...
                                 <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'jaFumou','errors')}">
                                    <g:checkBox onclick="Mudarestado('tempoParou')" class="form-control" size="50" placeholder="Digite jaFumou " id="jaFumou" name="jaFumou" size="50" value="${fieldValue(bean:questionariopresono,field:'jaFumou')}"></g:checkBox>
									<label for="jaFumou"><font size="3"><b>Ja Fumou</b></font></label>
                                </td>
                            </tr>

                              <tr class="prop" style="visibility:hidden;" id="tempoParou">
                                <td valign="top" class="name"></td>
                            ...
                            <tr class="prop" style="visibility:hidden;" id="qualTipo">
                                <td valign="top" class="name"></td>
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'qualTipo','errors')}">
									...
									<label for="qualTipo"><font size="3"><b>Qual Tipo</b></font></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'tempoFuma','errors')}">
                                    <input type="text" class="form-control" size="50" placeholder="Digite tempoFuma " id="tempoFuma" name="tempoFuma" size="50" value="${fieldValue(bean:questionariopresono,field:'tempoFuma')}"/>
                            ...
                            <tr class="prop">
                             ...
                             <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'usaMedicamentoDormir','errors')}">
                                    <g:checkBox onclick="Mudarestado('medicacao')" class="form-control" size="50" placeholder="Digite usaMedicamentoDormir " id="usaMedicamentoDormir" name="usaMedicamentoDormir" size="50" value="${fieldValue(bean:questionariopresono,field:'usaMedicamentoDormir')}"></g:checkBox>
                                ...
                                <tr class="prop" style="visibility:hidden;" id="medicacao">
                                    <td valign="top" class="name"></td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'quarto','errors')}">
									...
									<label for="quarto"><font size="3"><b>Quarto</b></font></label>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:questionariopresono,field:'voceRonca','errors')}">
                                    <g:checkBox onclick="Mudarestado('voceRoncaFrequencia')" class="form-control" size="50" placeholder="Digite voceRonca " id="voceRonca" name="voceRonca" size="50" value="${fieldValue(bean:questionariopresono,field:'voceRonca')}"></g:checkBox>
									<label for="voceRonca"><font size="3"><b>Voce Ronca</b></font></label>
                                </td>
                            </tr> 
                        
                            <tr class="prop" style="visibility:hidden;" id="voceRoncaFrequencia">
                                <td valign="top" class="name"></td>
