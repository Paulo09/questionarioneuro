...
<html>
    <head>       
        ...
        <title>Cadastrar Medicoresponsavel</title>         
    </head>
    ...
    <body style="background-image:url(${createLinkTo(dir:'images/view/create/backgroundPagina',file:'backgroundPagina.jpg')});background-repeat:no-repeat;background-size:cover;">
        <div class="card">
		  ...
		  <span class="card-title"><b>C</b>adastrar <b>Medicoresponsavel</b></span>
		</div>
        <div class="body">
            ...
            <g:form action="save" method="post" >
	            ...
	            <div class="buttons" align="center">
                    <span class="button"><input  class="btn waves-effect waves-light" style="background-image:url(${createLinkTo(dir:'images/view/create/botao',file:'botao.jpg')});" type="submit" value="Salvar"/></span>
                </div><br>
            </g:form>
        </div>
