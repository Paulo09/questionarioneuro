<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:hasErrors bean="${medicoresponsavel}"><div class="errors"><!--<g:renderErrors  bean="${medicoresponsavel}" as="list" />--></div>
                <body onload="showToast('${validacao}', 3000)">
            </g:hasErrors>
                   ...
                   <table class="striped left grey lighten-2">
                        <tbody>
                            ...
                            <div class="card-content yellow lighten-1">
                                <h4 align="center" class="white-text"><font color="#2196f3">Cadastrar Médico Responsável</font></h4>
                            </div>
