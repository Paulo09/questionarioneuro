...
<html>
    <head>       
        ...
        <title>Cadastrar Interfaceutilizada</title>         
    </head>
        ...
        <div class="body">
            ...
            <g:form action="save" method="post" >
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:interfaceutilizada,field:'descricao','errors')}">
                                    <i class="fa fa-pencil-square-o"></i><g:textArea type="text" placeholder="Digite descricao " class="form-control" id="descricao" name="descricao" value="${fieldValue(bean:interfaceutilizada,field:'descricao')}"/>
	            ...
	            <div class="buttons" align="center">
                    <span class="button"><input  class="btn waves-effect waves-light " style="padding:10px;margin:10px;size:30px;width:110px;" type="submit" value="Salvar"/></span>
                </div><br>
            </g:form>
        </div>
