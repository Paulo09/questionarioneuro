             ...
             <g:if test="${flash.message}">
				...
				<g:form action="buscar" method="post" class="convenio">
					<div class="list">
						...
						<label for="icon_telephone">Buscar: Nome Convênio</label>
					</div>
					</div>
				...
				<g:if test="${convenioList}">
						...
						<table class="striped centered grey lighten-2">
							...
							<nav class="nav-extended btn waves-effect waves-light blue lighten-2" style="background-image:url(${createLinkTo(dir:'images/view/list/backgroundPagina',file:'backgroundPagina.jpg')});">  
								<ul class="pagination  blue lighten-2 align='center'"><li class="active blue lighten-2" style="background-image:url(${createLinkTo(dir:'images/view/list/paginacao',file:'paginacao.jpg')});"><g:paginate total="${Convenio.count()}"/></ul>
							</nav>
						</div>
				</g:if>
