...
<html lang="PT">
  ...
  <body>
	...
	<nav class="nav-extended btn waves-effect waves-light red accent-4" >  
   ...
   <ul id="slide-out" class="side-nav">
		<li><div class="user-view">
		  <div class="background" style="background-image:url(images/lateralMenu/backgroundPagina/backgroundPagina.jpg);">
		  <img src="">
		  </div>
		  <a href="#!user"><img class="circle" src="images/lateralMenu/usuario/imagemUsuario.jpg"></a>
		...
		<div class="row">
			<div class="input-field col s9">
			  ...
			  <img align="right" src="https://chart.googleapis.com/chart?chs=150x200&cht=qr&chl=http://192.168.1.89:8080/teste/">
			</div>
		</div>		
	</ul>
      ...
      <main class="mdl-layout__content">
        <div class="demo-blog__posts mdl-grid">
		  ...
		  <div class="mdl-card something-else mdl-cell mdl-cell--4-col mdl-cell--4-col-desktop">
			<div class="mdl-card__media2" style="background-image:url(images/menu/classes/btnClasses.jpg);">
			<a href="">
			</div>
		...
		<div class="fixed-action-btn"> 
		  <a href="#" data-activates="slide-out" class="button-collapse btn btn-floating pulse red accent-4" style="background-image:url(${createLinkTo(dir:'images',file:'menu-background-botaocolapse-imagem.jpg')});"><i class="material-icons">menu</i></a>
        </div>
